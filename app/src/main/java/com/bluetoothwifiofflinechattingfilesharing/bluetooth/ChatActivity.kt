...
import com.bluetoothwifiofflinechattingfilesharing.databinding.ActChatBinding
...
import com.bluetoothwifiofflinechattingfilesharing.wifichat.HandleSocket
...
class ChatActivity : AppCompatActivity() {
    ...
    private var thisDeviceAddress: String = ""
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!mBluetoothAdapter.isEnabled) {
            ...
            getDbChats(mConnectedDeviceAddress)
            setupChat()
        }
    ...
    fun setRecycler(thisAddress: String, msg: String?) {
        ...
        if (perfix != "disconnectByOtherUser") {
            ...
            insertBlueChat(mConnectedDeviceAddress, thisAddress, msg, time)
    ...
    public override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (requestCode) {/* REQUEST_CONNECT_DEVICE_SECURE ->                 // When DeviceListActivity returns with a device to connect
    ...
    fun getDbChats(address: String) {
        CoroutineScope(Dispatchers.IO).launch {
            val list = database!!.insertDao().getOneChat("bluetooth", address)
            chatList.addAll(list)
            //chatList = ArrayList(list)
            runOnUiThread { }
            Log.d(TAG, "getDbChats: chat list fetched$chatList")
        }
    }
